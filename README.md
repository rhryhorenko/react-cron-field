...
The demo page lets the host app switch timezone props, toggle `12h`/`24h` display, test leading-zero behavior, inspect the built-in error area, and preview cosmetic dropdown hooks while the emitted cron stays in UTC.
